"""
ACENCIA ATLAS - Duplicate Compare Dialog
...
from PySide6.QtWidgets import (
    ...
    QFrame, QSplitter, QMenu, QMessageBox
)
from PySide6.QtCore import Qt, Signal, QTimer, QBuffer, QByteArray
from PySide6.QtPdf import QPdfDocument
from PySide6.QtPdfWidgets import QPdfView

from ui.archive.workers import PreviewDownloadWorker
from api.documents import DocumentsAPI, Document, BOX_DISPLAY_NAMES, safe_cache_filename
from ui.styles.tokens import DOCUMENT_DISPLAY_COLORS
from ui.utils.formatting import format_date_german

logger = logging.getLogger(__name__)

# PDF-Viewer Check (redundant if we import QPdfView, but good for safety if imports fail)
HAS_PDF_VIEW = False
try:
    from PySide6.QtPdfWidgets import QPdfView
    from PySide6.QtPdf import QPdfDocument
