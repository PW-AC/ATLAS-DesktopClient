"""
ACENCIA ATLAS - PDF Viewer Dialog

Dialog zur PDF-Vorschau und -Bearbeitung.
Extrahiert aus archive_view.py.
"""
...
from PySide6.QtWidgets import (
    QDialog, QVBoxLayout, QHBoxLayout, QToolBar, QLabel, QPushButton, QWidget,
    QListWidget, QListWidgetItem, QSplitter, QMessageBox, QSizePolicy,
    QApplication, QAbstractItemView
)
from PySide6.QtCore import Qt, Signal, QSize, QFileInfo, QTimer
from PySide6.QtGui import QFont, QAction, QIcon, QPixmap, QImage, QColor

from ui.archive.workers import ThumbnailWorker, PDFSaveWorker, PDFRefreshWorker
...
class PDFViewerDialog(QDialog):
    ...
    def _refresh_thumbnails(self):
        ...
        self._thumb_worker = ThumbnailWorker(self.pdf_path, page_count)
